...
(function XmlSerializer$Members () {
  ...
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm_CSharpXamlForHtml5_System_Xml_dll.System.Xml.Serialization.XmlSerializationReader)) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm_mscorlib.System.Object)) ();
  };
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm_mscorlib.System.IO.StreamWriter)) ();
  };
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm_mscorlib.System.IO.TextWriter)) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm_mscorlib.System.IDisposable)) ();
  };
  var $T0C = function () {
    return ($T0C = JSIL.Memoize($asm_CSharpXamlForHtml5_System_Xml_dll.System.Xml.Serialization.XmlSerializationWriter)) ();
  };
  var $T0D = function () {
    return ($T0D = JSIL.Memoize($asm_mscorlib.System.Func$b3.Of(
        $asm_mscorlib.System.String, $asm_mscorlib.System.Type, 
        $asm_mscorlib.System.Object
    ))) ();
  };
  var $T0E = function () {
    return ($T0E = JSIL.Memoize($asm_mscorlib.System.Func$b3.Of(
  ...
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.ConstructorSignature($asm_mscorlib.TypeRef("System.IO.StreamWriter"), [$asm_mscorlib.TypeRef("System.IO.Stream")]))) ();
  };
  var $S04 = function () {
    return ($S04 = JSIL.Memoize(JSIL.MethodSignature.Action($asm_mscorlib.TypeRef("System.String")))) ();
  };
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(new JSIL.ConstructorSignature($asm_mscorlib.TypeRef("System.NotImplementedException"), [$asm_mscorlib.TypeRef("System.String")]))) ();
  };
  var $IM00 = function () {
  ...
  function XmlSerializer_Serialize$05 (stream, o) {
    ...
    var streamWriter = $S03().Construct(stream);
    try {
      $S04().CallVirtual("Write", null, streamWriter, value);
      streamWriter['Flush']();
    } finally {
  ...
  function XmlSerializer_Serialize$06 (o, writer) {
    throw $S05().Construct("Please use the DataContractSerializer instead of the XmlSerializer.");
  };
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, "Deserialize", 
      ...
      JSIL.UntranslatableFunction("System.Object System.Xml.Serialization.XmlSerializer::Deserialize(System.Xml.XmlReader)")
    );
