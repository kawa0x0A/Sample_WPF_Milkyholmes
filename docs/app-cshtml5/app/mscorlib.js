...
(function TextInfo$Members () {
  ...
  JSIL.MakeType({
    ...
    $['Field']({Static:false, Public:false}, "m_dataHandle", $.IntPtr); 
    $['Field']({Static:false, Public:false}, "m_handleOrigin", $.IntPtr); 
    $['Field']({Static:false, Public:false}, "m_IsAsciiCasingSameAsInvariant", $asm_mscorlib.TypeRef("System.Nullable`1", [$.Boolean])); 
...
(function ConcurrentDictionary$b2$Members () {
  ...
  JSIL.MakeType({
    ...
    $['Constant']({Static:true , Public:false}, "DEFAULT_CONCURRENCY_MULTIPLIER", 4); 
...
(function Comparer$b1$Members () {
  ...
  JSIL.MakeType({
    ...
    $['Field']({Static:true , Public:false}, "defaultComparer", $asm_mscorlib.TypeRef("System.Collections.Generic.Comparer`1")); 
...
(function EqualityComparer$b1$Members () {
  ...
  JSIL.MakeType({
    ...
    $['Field']({Static:true , Public:false}, "defaultComparer", $asm_mscorlib.TypeRef("System.Collections.Generic.EqualityComparer`1")); 
...
(function ExecutionContext$Members () {
  ...
  JSIL.MakeType({
    ...
    $['Field']({Static:false, Public:false}, "_localValues", $asm_mscorlib.TypeRef("System.Collections.Generic.Dictionary`2", [$asm_mscorlib.TypeRef("System.Threading.IAsyncLocal"), $.Object])); 
    $['Field']({Static:false, Public:false}, "_localChangeNotifications", $asm_mscorlib.TypeRef("System.Collections.Generic.List`1", [$asm_mscorlib.TypeRef("System.Threading.IAsyncLocal")])); 
