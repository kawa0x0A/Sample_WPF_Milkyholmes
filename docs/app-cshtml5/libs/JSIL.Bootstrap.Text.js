...
JSIL.Trim = function (str, trimChars) {
    // TODO: Exceptions.
    if (trimChars.length == 0)
        trimChars.push(" ");
    for (var i = 0; i < str.length; i++) {
        if (trimChars.indexOf(str[i]) == -1) {
            break;
        }
    }
    var end = str.length - 1;
    for (var j = end; j >= 0; j--) {
        if (trimChars.indexOf(str[j]) == -1) {
            break;
        }
    }
    if (i == 0 && j == end)
...
JSIL.TrimStart = function (str, trimChars) {
    // TODO: Exceptions.
    if (trimChars.length == 0)
        trimChars.push(" ");
    for (var i = 0; i < str.length; i++) {
...
JSIL.TrimEnd = function (str, trimChars) {
    // TODO: Exceptions.
    if (trimChars.length == 0)
        trimChars.push(" ");
    var end = str.length - 1;
    ...
    $.Method({Static:true, Public:true }, "IndexOfAny", 
      ...
      function (str, chars, startIndex) {
        ...
        for (var i = startIndex || 0; i < chars.length; i++) {
          ...
          if ((result === null) || ((index > -1) && (index < result)))
            result = index;
        }
...
JSIL.MakeEnum(
  "System.StringSplitOptions", true, {
      None: 0,
      RemoveEmptyEntries: 1,
  }, true //todo: this bool means that it's a flag enum. Find out why this one is a Flag Enum because I don't see the logic.
);
...
JSIL.SplitString = function (str, separators, options) {
  ...
  if (separators.length === 1) {
      splittedString = str.split(separators[0]);
  } else {
    var regexText = "";
    ...
    splittedString = str.split(regex);
  }
  if (options && options.value) {
      //we need to remove the empty parts:
      var filteredSplittedString = new Array();
      for (i = 0; i < splittedString.length; i++) {
          var v = splittedString[i];
          if (v !== "")
            filteredSplittedString.push(splittedString[i]);
      }
      return filteredSplittedString;
  } else {
...
JSIL.ImplementExternals("System.Text.Encoding", function ($) {
  ...
  $.Method({Static:false, Public:true }, "GetChars", 
    ...
    function GetChars (bytes, byteIndex, byteCount, chars, charIndex) {
        var resultAsCharArray = this.$stringToChars(this.$decode(bytes, byteIndex, byteCount));
        var i = 0;
        for (i = 0; i < resultAsCharArray.length; ++i) {
            chars[charIndex + i] = resultAsCharArray[i];
        }
        return i;
    }
  );
...
JSIL.ImplementExternals("System.Text.UTF8Encoding+UTF8Decoder", function ($) {

    function UTF8Decoder__ctor() {
        var $T00 = function () {
            return ($T00 = JSIL.Memoize(System.Text.Decoder))();
        };
    ...
    $.Method({ Static: false, Public: true, Virtual: true }, "GetCharCount",
      new JSIL.MethodSignature($.Int32, [
          $jsilcore.TypeRef("System.Array", [$.Byte]), $.Int32,
          $.Int32
      ]),
      function (bytes, index, count) {

          var $S00 = function () {
              return ($S00 = JSIL.Memoize(new JSIL.MethodSignature($jsilcore.TypeRef("System.Int32"), [
                  $jsilcore.TypeRef("System.Array", [$jsilcore.TypeRef("System.Byte")]), $jsilcore.TypeRef("System.Int32"),
                  $jsilcore.TypeRef("System.Int32")
              ])))();
          };
          var $T03 = function () {
              return ($T03 = JSIL.Memoize(System.Text.Encoding))();
          };

          return $S00().CallVirtual("GetCharCount", null, $T03()['get_UTF8'](), bytes, index, count);
      }
    );

    $.Method({ Static: false, Public: true, Virtual: true }, "GetChars",
      new JSIL.MethodSignature($.Int32, [
          $jsilcore.TypeRef("System.Array", [$.Byte]), $.Int32,
          $.Int32, $jsilcore.TypeRef("System.Array", [$.Char]),
          $.Int32
      ]),
      function (bytes, byteIndex, byteCount, chars, charIndex) {
          ...
          var $S01 = function () {
              return ($S01 = JSIL.Memoize(new JSIL.MethodSignature($jsilcore.TypeRef("System.Int32"), [
                  $jsilcore.TypeRef("System.Array", [$jsilcore.TypeRef("System.Byte")]), $jsilcore.TypeRef("System.Int32"),
                  $jsilcore.TypeRef("System.Int32"), $jsilcore.TypeRef("System.Array", [$jsilcore.TypeRef("System.Char")]),
                  $jsilcore.TypeRef("System.Int32")
              ])))();
          };

          return $S01().CallVirtual("GetChars", null, $T03()['get_UTF8'](),
            bytes,
            byteIndex,
            byteCount,
            chars,
...
JSIL.MakeClass("System.Text.Decoder", "System.Text.UTF8Encoding+UTF8Decoder", false, [], function ($) {
});
...
JSIL.ImplementExternals("System.Text.UTF8Encoding", function ($) {
  ...
  $.Method({Static:false, Public:true , Virtual:true }, "GetDecoder", 
    JSIL.MethodSignature.Return($jsilcore.TypeRef("System.Text.Decoder")), 
  function () {
      var DecoderConst = function () {
          return (DecoderConst = JSIL.Memoize($jsilcore.System.Text.UTF8Encoding_UTF8Decoder))();//$jsilcore.TypeRef("System.Text.UTF8Encoding_UTF8Decoder")
      };
      return new (DecoderConst())();
  }
);
...
JSIL.ImplementExternals("System.Text.StringBuilder", function ($) {
  ...
  function MainPage_Remove(startIndex, length, $exception) {

      var ArgumentOutOfRangeException = function () {
          return (ArgumentOutOfRangeException = JSIL.Memoize(new JSIL.ConstructorSignature($jsilcore.TypeRef("System.ArgumentOutOfRangeException"), [$jsilcore.TypeRef("System.String")])))();
      };
      if (startIndex < 0) {
          throw ArgumentOutOfRangeException().Construct("startIndex cannot be less than 0.");
      }
      if (length < 0) {
          throw ArgumentOutOfRangeException().Construct("length cannot be less than 0.");
      }
      if (startIndex + length > this._str.length) {
          throw ArgumentOutOfRangeException().Construct("startIndex + length cannot be greater than the length of this instance.");
      }
      this._str = this._str.substr(0, startIndex) + this._str.substr(startIndex + length);
      //this._str = (System.String.Remove(this._str, startIndex, length));
      return this;
  }
);
...
JSIL.ImplementExternals("System.Text.RegularExpressions.Regex", function ($) {
  ...
  var makeRegex = function (pattern, options) {
    var tRegexOptions = System.Text.RegularExpressions.RegexOptions;
  ...
  $.Method({Static:false, Public:true }, ".ctor", 
    (new JSIL.MethodSignature(null, [$.String, $jsilcore.TypeRef("System.Text.RegularExpressions.RegexOptions")], [])), 
  ...
  $.Method({Static:false, Public:true }, "Matches", 
    (new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.MatchCollection"), [$.String], [])),
    function Matches (input) {      
      var matchObjects = [];
      var tMatch = System.Text.RegularExpressions.Match.__Type__;
      var tGroup = System.Text.RegularExpressions.Group.__Type__;
      var tGroupCollection = System.Text.RegularExpressions.GroupCollection.__Type__;
    ...
    $.Method({Static:false, Public:true }, "Match",
    (new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Match"), [$.String], [])),
    function Match(input) {
        var matchObjects = [];
        var tMatch = System.Text.RegularExpressions.Match.__Type__;
        var tGroup = System.Text.RegularExpressions.Group.__Type__;
        var tGroupCollection = System.Text.RegularExpressions.GroupCollection.__Type__;
        var formerRegexLastIndex = this._regex.lastIndex;
        var current = this._regex.exec(input);
        if (current !== null) {
            var groupObjects = [];
            for (var i = 0, l = current.length; i < l; i++) {
                var groupObject = JSIL.CreateInstanceOfType(
            ...
            this._regex.lastIndex = formerRegexLastIndex;


            return result;
        }
        else {
            return System.Text.RegularExpressions.Match['get_Empty']();
        }
    }
  ...
  $.Method({Static:true , Public:true }, "Replace", 
    (new JSIL.MethodSignature($.String, [
          $.String, $.String, 
          $.String, $jsilcore.TypeRef("System.Text.RegularExpressions.RegexOptions")
        ], [])), 
  ...
  $.Method({Static:false, Public:true }, "IsMatch",
    ...
    function Regex_IsMatch(input, startat) {
        var temp = (input.substr(startat));
        return this['IsMatch'](temp);
    }
  );

  $.Method({Static:true , Public:true }, "IsMatch",
    new JSIL.MethodSignature($.Boolean, [$.String, $.String]),
    function Regex_IsMatch(input, pattern) {
        return ($S03().Construct(pattern, $T01().ECMAScript))['IsMatch'](input);
    }
  );
  ...
  $.Method({Static:true , Public:true }, "IsMatch",
    new JSIL.MethodSignature($.Boolean, [
        $.String, $.String,
        $jsilcore.TypeRef("System.Text.RegularExpressions.RegexOptions")
    ]),
      function Regex_IsMatch(input, pattern, options) {
          return ($S03().Construct(pattern, options))['IsMatch'](input);
      }

  );

  var $T01 = function () {
      return ($T01 = JSIL.Memoize($jsilcore.System.Text.RegularExpressions.RegexOptions))();
  };

  var $T05 = function () {
      return ($T05 = JSIL.Memoize($jsilcore.System.Char))();
  };

  var $T06 = function () {
      return ($T06 = JSIL.Memoize($jsilcore.System.Text.RegularExpressions.Regex))();
  };

  var $T09 = function () {
      return ($T09 = JSIL.Memoize($jsilcore.System.Linq.Enumerable))();
  };

  var $T0A = function () {
      return ($T0A = JSIL.Memoize($jsilcore.System.Collections.Generic.IEnumerable$b1.Of($jsilcore.System.Char)))();
  };

  var $S00 = function () {
      return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($jsilcore.TypeRef("System.Text.StringBuilder"), null)))();
  };

  var $S01 = function () {
      return ($S01 = JSIL.Memoize(new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.StringBuilder"), [
  ...
  var $S02 = function () {
      return ($S02 = JSIL.Memoize(new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.StringBuilder"), [$jsilcore.TypeRef("System.Char")])))();
  };

  var $S03 = function () {
      return ($S03 = JSIL.Memoize(new JSIL.ConstructorSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Regex"), [$jsilcore.TypeRef("System.String"), $jsilcore.TypeRef("System.Text.RegularExpressions.RegexOptions")])))();
  };

  var $S04 = function () {
      return ($S04 = JSIL.Memoize(new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Match"), [
          $jsilcore.TypeRef("System.String"), $jsilcore.TypeRef("System.String"),
          $jsilcore.TypeRef("System.Text.RegularExpressions.RegexOptions")
      ])))();
  };
  ...
  $.Method({ Static: true, Public: false }, "IsMetachar",
    new JSIL.MethodSignature($.Boolean, [$.Char]),
    function Regex_IsMetachar(ch) {
        var metachars = JSIL.Array.New($T05(), ["\\", "*", "+", "?", "|", "{", "[", "(", ")", "^", "$", ".", "#", " "]);
        return ($T09()['ToList$b1']($T05())($T0A().$Cast(metachars)))['Contains'](ch);
    }
  );

  $.Method({Static:true , Public:true }, "Escape",
  (new JSIL.MethodSignature($.String, [$.String], [])),
  function Regex_Escape(str) {
      for (var i = 0; i < (str.length | 0) ; i = ((i + 1) | 0)) {
          if (this['IsMetachar'](str[i])) {
              var sb = $S00().Construct();
              var ch = (str[i]);
              $S01().CallVirtual("Append", null, sb, str, 0, i);

              do {
                  $S02().CallVirtual("Append", null, sb, "\\");
                  $S02().CallVirtual("Append", null, sb, ch);
                  i = ((i + 1) | 0);
                  var lastpos = i;
                  ...
                  $S01().CallVirtual("Append", null, sb, str, lastpos, ((i - lastpos) | 0));
              } while (i < (str.length | 0));
  ...
  $.Method({Static:false, Public:true }, "Match",
    new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Match"), [$.String, $.Int32]),
    function Regex_Match(input, startat) {
        var temp = (input.substr(startat));
        return this['Match'](temp);
    }
  );

  $.Method({Static:true , Public:true }, "Match",
    new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Match"), [$.String, $.String]),
    function Regex_Match(input, pattern) {
        return $S04().CallStatic($thisType, "Match", null, input, pattern, $T01().ECMAScript);
    }
  );

  $.Method({Static:false, Public:true }, "Match",
    new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Match"), [
        $.String, $.Int32,
        $.Int32
    ]),
    function Regex_Match(input, beginning, length) {
        var temp = (input.substr(beginning, length));
        return this['Match'](temp);
    }
  );
  ...
  $.Method({Static:true , Public:true }, "Match",
    ...
    function Regex_Match (input, pattern, options) {
        return ($S03().Construct(pattern, options))['Match'](input);
    }
  );

  $.Method({Static:false, Public:true }, "Matches",
    new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.MatchCollection"), [$.String, $.Int32]),
    function Regex_Matches (input, startat) {
        var temp = (input.substr(startat));
        return this['Matches'](temp);
    }
  );

  $.Method({Static:true , Public:true }, "Matches",
    new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.MatchCollection"), [$.String, $.String]),
    function Regex_Matches (input, pattern) {
        return ($S03().Construct(pattern, $T01().ECMAScript))['Matches'](input);
    }
  );

  $.Method({Static:true , Public:true }, "Matches",
    new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.MatchCollection"), [
        $.String, $.String,
        $jsilcore.TypeRef("System.Text.RegularExpressions.RegexOptions")
    ]),
    function Regex_Matches (input, pattern, options) {
        return ($S03().Construct(pattern, options))['Matches'](input);
    }
  );
  ...
  $.Method({Static:true , Public:true }, "Unescape",
    new JSIL.MethodSignature($.String, [$.String]),
    function Regex_Unescape (str) {

        for (var i = 0; i < (str.length | 0); i = ((i + 1) | 0)) {
            if (((str[i])['charCodeAt'](0) | 0) === (("\\")['charCodeAt'](0) | 0)) {
                var sb = $S00().Construct();
                $S01().CallVirtual("Append", null, sb, str, 0, i);

                do {
                    i = ((i + 1) | 0);
                    if (!((i !== (str.length | 0)) && (((str[i])['charCodeAt'](0) | 0) !== (("\\")['charCodeAt'](0) | 0)))) {
                        $S02().CallVirtual("Append", null, sb, "\\");
                        i = ((i + 1) | 0);
                    }
                    var lastpos = i;

                    while ((i < (str.length | 0)) && (((str[i])['charCodeAt'](0) | 0) !== (("\\")['charCodeAt'](0) | 0))) {
                        i = ((i + 1) | 0);
                    }
                    $S01().CallVirtual("Append", null, sb, str, lastpos, ((i - lastpos) | 0));
                } while (i < (str.length | 0));
  ...
  $['Field']({ Static: false, Public: false }, "_options", $jsilcore.TypeRef("System.Text.RegularExpressions.RegexOptions"));
  $['Field']({ Static: true, Public: true, ReadOnly: true }, "InfiniteMatchTimeout", $jsilcore.TypeRef("System.TimeSpan"));
  function Regex__cctor() {
      $thisType.InfiniteMatchTimeout = new $jsilcore.System.TimeSpan();
      $thisType.InfiniteMatchTimeout = $jsilcore.System.TimeSpan.MaxValue['MemberwiseClone']();
  };
...
JSIL.ImplementExternals("System.Text.RegularExpressions.MatchCollection", function ($) {
  ...
  $.Method({Static:false, Public:true }, "get_Item", 
    (new JSIL.MethodSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Match"), [$.Int32], [])),
    function get_Item (i) {
...
JSIL.MakeClass($jsilcore.TypeRef("System.Object"), "System.Text.RegularExpressions.Capture", true, [], function ($) {
    var $thisType = $.publicInterface;
});
...
JSIL.ImplementExternals("System.Text.RegularExpressions.Group", function ($) {
  ...
  //don't know how to get this so we remove it.
  //$.Method({ Static: false, Public: true }, "get_Captures",
  //  JSIL.MethodSignature.Return($asm01.TypeRef("System.Text.RegularExpressions.CaptureCollection")),
...
JSIL.MakeClass($jsilcore.TypeRef("System.Object"), "System.Text.RegularExpressions.Group", true, [], function ($) {
    var $thisType = $.publicInterface;
});
...
JSIL.ImplementExternals("System.Text.RegularExpressions.Match", function ($) {
  ...
  var $S05 = function () {
      return ($S05 = JSIL.Memoize(new JSIL.ConstructorSignature($jsilcore.TypeRef("System.Text.RegularExpressions.Match"), [])))();
  };

  $.Method({ Static: true, Public: true }, "get_Empty",
    JSIL.MethodSignature.Return($.Type),
    function get_Empty() {
        var empty = $S05().Construct();
        empty._text = "";
        var groupObjects = [];
        var tGroupCollection = System.Text.RegularExpressions.GroupCollection.__Type__;
        var groupCollection = JSIL.CreateInstanceOfType(
        ...
        empty._groupcoll = groupCollection;
        empty._length = 0;
        return empty;
...
JSIL.MakeClass($jsilcore.TypeRef("System.Text.RegularExpressions.Group"), "System.Text.RegularExpressions.Match", true, [], function ($) {
    var $thisType = $.publicInterface;
});
...
JSIL.ImplementExternals("System.Text.RegularExpressions.GroupCollection", function ($) {
  var system = JSIL.GetAssembly("System", true);
  var $thisType = $.publicInterface;
  var tEnumerator = JSIL.ArrayEnumerator.Of(System.Text.RegularExpressions.Group);
...
JSIL.MakeClass($jsilcore.TypeRef("System.Object"), "System.Text.RegularExpressions.GroupCollection", true, [], function ($) {
    var $thisType = $.publicInterface;
});
...
JSIL.ImplementExternals("System.Char", function ($) {  
  ...
  $.Method({ Static: true, Public: true }, "IsUpper",
  new JSIL.MethodSignature($.Boolean, [$.Char], []),
  function IsUpper(c) {
      // FIXME: Unicode
      var charCode = c.charCodeAt(0);
  ...
  $.Method({ Static: true, Public: true }, "IsLower",
  new JSIL.MethodSignature($.Boolean, [$.Char], []),
  function IsLower(c) {
      // FIXME: Unicode
      var charCode = c.charCodeAt(0);
