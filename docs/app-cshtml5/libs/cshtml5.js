...
//      -globalIndexes.isStartFound and globalIndexes.isEndFound: a boolean stating whether the index has been found yet ot not (only used within this method to know when to stop changing the indexes.
